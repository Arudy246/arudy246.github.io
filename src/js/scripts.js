...
window.Stamina = function () {
	...
	let CurST = state.getVar('$plr.stats.stamina.cur')
	let MaxST = state.getVar('$plr.stats.stamina.max')
	let Horizontal = true
	let BarID = 'staminaBar'
...
window.Life = function () {
	let Container = document;
	let CurHP = state.getVar('$plr.stats.life.cur')
	let MaxHP = state.getVar('$plr.stats.life.max')
	let Horizontal = true
	let BarID = 'lifeBar'
...
window.Sanity = function () {
	let Container = document;
	let CurSan = state.getVar('$plr.stats.sanity.cur')
	let MaxSan = state.getVar('$plr.stats.sanity.max')
	let Horizontal = true
	let BarID = 'sanityBar'
...
window.FocusStat = function () {
	let Container = document;
	let CurCon = state.getVar('$plr.stats.focus.cur')
	let MaxCon = state.getVar('$plr.stats.focus.max')
	let Horizontal = true
	let BarID = 'focusBar'
...
//Enemy NPC Stat Bars
window.EnemyStamina = function (CurST, MaxST) {

	let Container = document;

	let Horizontal = true
	let BarID = 'enemystaminaBar'
	...
	BarElement.attr("title", CurST + "/" + MaxST + " Stamina");
    $(Container).find("#enemystamina").text(CurST + "/" + MaxST);
	$(Container).find("#" + BarID + "bkg").attr("title", CurST + "/" + MaxST + " Stamina");
};

window.EnemyLife = function (CurHP, MaxHP) {
	let Container = document;
	let Horizontal = true
	let BarID = 'enemylifeBar'
	...
	BarElement.attr("title", CurHP + "/" + MaxHP + " Life");
    $(Container).find("#enemylife").text(CurHP + "/" + MaxHP);
	$(Container).find("#" + BarID + "bkg").attr("title", CurHP + "/" + MaxHP + " Life");
};
...
/* Dialog Click Next System - START */
